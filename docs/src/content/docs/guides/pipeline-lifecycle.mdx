...
description: Everything that happens between "/quack execute" on a raw issue and a PR ready for review.
---
...
**Setup:** issue **#42** — *"Add dark mode toggle"* — with a two-sentence body. You comment `/quack execute`.

## The timeline

| # | Actor | What happens | What you see |
|---|-------|--------------|--------------|
| 1 | You | Comment on #42 | `/quack execute` |
...
- **You review between stages:** run `/quack architect`, `engineer`, `execute` separately — the cascade only fills in stages you skipped.
