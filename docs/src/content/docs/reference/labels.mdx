...
The [Reviewer](/agents/reviewer) sits outside the four-agent pipeline, but still carries its own stage labels — with two possible terminal states instead of one, driven by the review verdict:
