...
AGENTS=(architect engineer execute fix revert close review triage merge)
BUILTINS="architect design engineer tactics execute run work fix revert close review triage merge"
