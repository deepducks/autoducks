...
4. **[LLM]** Explores the repository (read-only) and writes the design with sections: *Problem Statement, Proposed Solution, Technical Design, Dependencies, Constraints, Out of Scope*. Classifies the issue as `Feature` or `Bug`.
