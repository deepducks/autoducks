...
AGENTS=(architect engineer execute fix revert close review rework defer)
BUILTINS="architect design engineer tactics execute run work fix revert close review rework defer"
